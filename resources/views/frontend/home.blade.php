...
<meta property="og:url" content="127.0.0.1:8001">
        ...
        <div class="row">
          ...
          @foreach ($kegiatan as $kegiatan)
              ...
              <div class="icon-box iconbox-blue">
                ...
                <h4><a href="{{ route('kegiatanshow',$kegiatan->slug) }}">{{ $kegiatan->title }}</a></h4>
                <p>{{ $kegiatan->quote }}</p>
              </div>
            </div>
          @endforeach
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item {{ $gallery->gallerycategory_id }}">
            <img src="{{ asset('storage/'.$gallery->cover) }}" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>{{ $gallery->name }}</h4>
              {{-- <p>{{ $gallery->category->name }}</p> --}}
              <a href="{{ asset('storage/'.$gallery->cover) }}" data-gall="portfolioGallery" class="venobox preview-link" title="{{ $gallery->name }}"><i class="bx bx-plus"></i></a>
              {{-- <a href="{{ route('portfolioshow',$gallery->slug) }}" class="details-link" title="More Details"><i class="bx bx-link"></i></a> --}}
            </div>
          </div>
          @endforeach
